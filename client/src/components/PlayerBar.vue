  ...
  <div>
    <div class="row q-mx-md">
      ...
      <div class="row col-2">
        ...
        <div
          class="column q-mt-sm q-pt-xs q-pl-sm"
          style="width: calc(100% - 50px)"
        >
          <div class="text-caption text-weight-bold full-width">
            <div
              v-if="$1t.player.value.title"
      ...
      <div class="row col-2 justify-end">
        ...
        <div v-if="enablePlaylist">
          <PlaylistDropZone
            ...
            "
            @click.native="
              $1t.onQuickTagEvent('generatePlaylist');
              $1t.quickTagUnfocus();
            "
...
onMounted(() => {
  ...
  enablePlaylist.value =
    useRouter().currentRoute.value.path.includes("quicktag");
});
...
const art = computed(
  () =>
    `${httpUrl()}/thumb?path=${encodeURIComponent($1t.player.value.path ?? "")}`,
);
</script>
