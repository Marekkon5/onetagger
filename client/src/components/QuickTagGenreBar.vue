    ...
    <div class="row q-mx-md q-pt-sm no-wrap genre-bar-container">
      ...
      >
        <div
          ...
          :class="{
            'text-weight-bold': isSelected(genre.genre) || mouseOver == i,
            'text-grey-7': !isSelected(genre.genre) && mouseOver != i,
          }"
...
function onMouseLeave() {
  ...
  if ($1t.settings.value.quickTag.genres[mouseOver.value].subgenres.length > 0)
    return;
  mouseOver.value = -1;
}
</script>
