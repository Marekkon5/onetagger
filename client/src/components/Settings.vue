<template>
  <q-dialog v-model="open" @hide="close()">
    <q-card flat class="parent-card bg-dark q-pa-lg">
      ...
      <q-card-section>
        <div
          class="text-subtitle2 text-bold q-mb-sm text-center text-uppercase text-primary"
        >
          Settings
        </div>
        <q-tabs v-model="tab">
      ...
      <q-card-section>
        ...
        <div v-if="tab == 'quicktag'">
          ...
          <div class="select">
            <div class="col-1"></div>
            <div
              class="text-uppercase text-primary text-subtitle2 text-bold q-mt-sm q-mb-sm text-center"
            >
              Input
            </div>
          ...
          <q-separator
            class="q-mx-auto"
            :style="'max-width: 513px; margin-top: 24px; margin-bottom: 35px'"
            inset
            color="darker"
          />
          <div
            class="text-uppercase text-primary text-subtitle2 text-bold q-mt-lg text-center"
            style="margin-top: 31px"
          >
            Energy
          </div>
          <div
            class="q-mb-sm q-mt-md text-grey-5 text-uppercase text-caption row justify-between"
          >
            <span>Stars</span>
            <span class="text-grey-5 text-uppercase text-caption"
              >Key binds</span
            >
          </div>
          ...
          <!-- Energy settings -->
          <div
            class="q-mb-sm row justify-between text-grey-5 text-uppercase text-caption"
          >
            <span>Tag frame</span>
          ...
          <div
            v-if="$1t.settings.value.quickTag.energyTag.type != 'rating'"
            class="row"
          >
            <div class="col-2 q-pr-md">
              <q-input
                v-model="$1t.settings.value.quickTag.energyTag.symbol"
                filled
                dense
                label="Symbol"
              ></q-input>
            ...
            <div class="col-10 q-mb-xs" :style="'margin-bottom: -4px'">
              <TagFields
                dense
                v-model="$1t.settings.value.quickTag.energyTag.tag"
              ></TagFields>
            </div>
          </div>
          ...
          <div
            class="text-grey-5 text-uppercase text-caption q-mt-md q-mb-sm row justify-between"
          >
            <span>Tag frame</span>
            <span class="text-grey-5 text-uppercase text-caption">Save to</span>
          </div>
          <TagFields
            class="q-mb-sm"
            v-model="$1t.settings.value.quickTag.moodTag"
          ></TagFields>
          ...
          <div class="q-mb-md">
            <draggable
              v-model="$1t.settings.value.quickTag.moods"
              :item-key="(e: any) => `mood`"
            >
            ...
            <!-- Add new mood -->
            <div
              class="q-mt-sm q-mb-sm text-uppercase text-primary text-subtitle2"
            >
              Add new mood
            </div>
            <div class="row">
              <q-input
                ...
                filled
                dense
                class="col-5 q-pr-md q-mb-lg"
              ></q-input>
              <q-select
                v-model="newMood.color"
                :options="colors"
                filled
                dense
                class="col-5 q-pr-md"
          ...
          <q-separator
            class="q-mx-auto"
            :style="'max-width: 513px; margin-top: 16px; margin-bottom: 35px'"
            inset
            color="darker"
          />
          <div
          ...
          <div>
            <draggable
              v-model="$1t.settings.value.quickTag.genres"
              :item-key="(e: any) => `genre`"
            >
              <template #item="{ element, index: i }">
                <div>
                  ...
                  <div class="row">
                    <div class="col-2 text-body q-mt-sm text-primary">
                      Subgenres:
                    </div>
                    <q-input
                      clearable
                      ...
                      @update:model-value="
                        (e) => onSubgenreInput(e as string, i)
                      "
                      :model-value="
                        (
            ...
            <!-- Add new genre -->
            <div class="q-mb-sm text-uppercase text-primary text-subtitle2">
              Add new genre
            </div>
            <div class="row">
              <q-input
            ...
            <div class="q-mt-md q-mb-sm">
              ...
              ></q-checkbox>
              <TagFields
                v-if="$1t.settings.value.quickTag.subgenreTag"
                class="col-10 q-mt-sm q-mb-md"
                style="margin-bottom: 20px"
                dense
                v-model="$1t.settings.value.quickTag.subgenreTag"
              ></TagFields>
            </div>
        ...
        <div v-if="tab == 'quicktag-custom'">
          ...
          <div class="text-center" style="margin-bottom: 40px">
            <Separators
              v-model="$1t.settings.value.quickTag.separators"
            ></Separators>
          </div>

          <!-- Advanced -->
          <div
            class="text-uppercase text-primary text-subtitle2 text-bold q-mt-lg q-mb-sm text-center"
          >
            TAG OPTIONS
          </div>
          ...
          <q-separator
            class="q-mx-auto"
            :style="'max-width: 513px; margin-top: 20px; margin-bottom: 35px'"
            inset
            color="darker"
          />
          ...
          <div class="row">
            <TagFields
              ...
              style="margin-bottom: 20px"
              dense
              v-model="$1t.settings.value.quickTag.noteTag.tag"
            ></TagFields>
            <KeybindVue
              class="col-2 text-center"
          ...
          <q-separator
            class="q-mx-auto"
            :style="'max-width: 513px; margin-top: 0px; margin-bottom: 35px'"
            inset
            color="darker"
          />
          <div class="q-mb-lg" style="margin-bottom: 29px"></div>
          <div
            v-for="(tag, i) in $1t.settings.value.quickTag.custom"
            :key="'tag' + i"
          >
            <div class="row">
              <div
              ...
              <q-input
                ...
                filled
                v-if="customQTEdit[i]"
                v-model="$1t.settings.value.quickTag.custom[i].name"
              ></q-input>
              <div class="q-mx-md mt-2">
                ...
                <q-btn
                  ...
                  color="primary"
                  @click="reorderCustomQT(i, 1)"
                  v-if="i != $1t.settings.value.quickTag.custom.length - 1"
                ></q-btn>
                <q-btn
                  size="sm"
                  class="q-mr-sm"
            ...
            <TagFields
              class="q-pt-sm"
              v-model="$1t.settings.value.quickTag.custom[i].tag"
            ></TagFields>
              ...
              <template #item="{ element, index: j }">
                <div class="row">
                  <q-btn
                    ...
                    icon="mdi-close"
                    @click="
                      $1t.settings.value.quickTag.custom[i].values.splice(j, 1)
                    "
                  ></q-btn>
                  <q-input
                    ...
                    filled
                    v-model="
                      $1t.settings.value.quickTag.custom[i].values[j].val
                    "
                  ></q-input>
                  <KeybindVue
                    class="col-2 text-center q-pt-sm"
                    v-model="
                      $1t.settings.value.quickTag.custom[i].values[j].keybind
                    "
                  ></KeybindVue>
                </div>
              </template>
          ...
          <div class="row q-mt-md">
            <div
              class="q-mb-sm text-uppercase text-primary text-subtitle2 q-my-lg col-4"
            >
              Add new section
            </div>
            <q-input
        ...
        <div v-if="tab == 'advanced'">
          ...
          <q-separator
            class="q-mx-auto"
            :style="'max-width: 513px; margin-top: -8px; margin-bottom: 35px'"
            inset
            color="darker"
          />

          <div
            class="text-uppercase text-primary text-subtitle2 text-bold q-mt-lg q-mb-xs text-left"
          >
            Auto Tag
          </div>
          <q-checkbox
          ...
          <!-- Color picker -->
          <div
            class="text-uppercase text-primary text-subtitle2 text-bold q-mt-lg q-mb-md text-left"
          >
            Primary color
          </div>
          <q-color
          ...
          <q-btn
            @click="
              $1t.settings.value.primaryColor = '#00d2bf';
              colorChange();
            "
            color="primary"
            flat
...
const newMood: Ref<{ mood?: string; color: string; keybind?: Keybind }> = ref({
  mood: undefined,
  color: "red",
  keybind: undefined,
});
...
function addMood() {
  if (newMood.value.mood) {
    // Exists
    if (
      $1t.settings.value.quickTag.moods.find(
        (m) => newMood.value.mood!.toLowerCase() == m.mood.toLowerCase(),
      )
    )
      return;
    $1t.settings.value.quickTag.moods.push(
      JSON.parse(JSON.stringify(newMood.value)),
    );
...
function addGenre() {
  ...
  if (
    $1t.settings.value.quickTag.genres.find(
      (g) => g.genre.toLowerCase() == newGenre.value!.toLowerCase(),
    )
  )
    return;
  $1t.settings.value.quickTag.genres.push({
...
function enableCustomSubgenreTag(enable: boolean) {
  if (enable) {
    $1t.settings.value.quickTag.subgenreTag = new FrameName(
      "TCON",
      "GENRE",
      "©gen",
    );
...
function addNewQTValue(i: number) {
  $1t.settings.value.quickTag.custom[i].values.push({
    val: "New",
    keybind: undefined,
  });
...
function reorderCustomQT(now: number, offset: number) {
  ...
  $1t.settings.value.quickTag.custom[now + offset] =
    $1t.settings.value.quickTag.custom[now];
