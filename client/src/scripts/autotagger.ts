...
class AutotaggerConfig {
  ...
  loadSettings(data: any) {
    ...
    this.stylesCustomTag = Object.assign(
      FrameName.same("STYLE"),
      data.stylesCustomTag,
    );
...
const SUPPORTED_TAGS = [
  {
    tag: SupportedTag.AlbumArt,
    label: "Album Art",
    tooltip: "Resolution is platform dependent",
  },
  ...
  {
    tag: SupportedTag.Genre,
    label: "Genre",
    tooltip: "Spotify will populate multiple genres based on artist",
  },
  ...
  {
    tag: SupportedTag.OtherTags,
    label: "Other Tags",
    tooltip: "Specific tags only for some platforms",
  },
  {
    tag: SupportedTag.MetaTags,
    label: "OneTagger Tags",
    tooltip: "Adds 1T_TAGGEDDATE tag with timestamp",
  },
